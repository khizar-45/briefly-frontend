...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 h-20 w-full flex gap-4 justify-center items-center z-[10] px-8 py-4">
      <div className="flex items-center justify-between w-full max-w-6xl mx-auto dark:bg-[#1d1d1dcb] backdrop-blur-lg overflow-x-hidden rounded-xl px-6 py-4 mt-4 border border-white/30 bg-white/90 shadow-lg transition-all duration-300 md:px-20">
